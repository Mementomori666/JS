...
class PageController{
    public function actionAddArticle(){
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if(isset($_POST['udk'])) $article->setKeyWordsEn($_POST['udk']);
            if(isset($_POST['doi'])) $article->setKeyWordsEn($_POST['doi']);
            if(isset($_POST['grnti'])) $article->setKeyWordsEn($_POST['grnti']);
